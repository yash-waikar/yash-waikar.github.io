...
export default function Strands({
  ...
  useEffect(() => {
    ...
    function resize() {
      ...
      // Shader math must use the actual drawing-buffer size (scaled by dpr),
      // not the CSS size, or the wave centers in the wrong place.
      const bufW = gl.drawingBufferWidth;
      const bufH = gl.drawingBufferHeight;
      program.uniforms.uResolution.value = [bufW, bufH];
      renderTarget.setSize(bufW, bufH);
